...
public class CategoriaResource {
	...
	@PostMapping
	public ResponseEntity<Categoria> create(@Valid @RequestBody Categoria obj){ //@Valid verifica as validações no model
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<CategoriaDTO> update(@Valid @PathVariable Integer id,@RequestBody CategoriaDTO objDto){// @Valid verifica as validações no model
